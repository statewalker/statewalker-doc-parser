...
import parseMdBlocksSeparators from "../src/parseMdBlocksSeparators.js";

describe("parseMdBlocksSeparators", () => {
  ...
  function testPartial(str, control) {
    const result = parseMdBlocksSeparators(str);
    try {
  ...
  it(`should parse markdown blocks`, async () => {
    test("*** ", {
  ...
  it(`should parse markdown blocks with associated properties`, async () => {
    testPartial(
      `***  
      a : This is the 
      first property
