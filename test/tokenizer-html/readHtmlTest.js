...
import splitToHtmlTokens from "../../src/tokenizer-html/splitToHtmlTokens.js";
import TreeBuilder from "./handlers/TreeBuilder.js";
import processHtml from "./handlers/processHtml.js";
import transformHtmlTokens from "../tokenizer-html/handlers/transformHtmlTokens.js";
...
describe("readHtmlTokens", () => {
  ...
  it(`should read text strings`, async () => {
    test("", {});
    test("abc", "abc");
  });

  it('should be able read empty tags', () => {
    test(`<div>`, {
      "type": "div"
    });
    test(`<div></div>`, {
  ...
  it("should be able to read broken attributes", () => {
  ...
  it('should read attributes with colons', () => {
  ...
  it('should read attributes with dots', () => {
    test(`<h1 foo.bar=baz>Abc`, {
      "type": "h1",
      "attrs": { 'foo.bar': 'baz' },
      "children": ["Abc"]
  ...
  it('should read tags with a colon', () => {
  ...
  it('should read tag names with colon', () => {
    test(`<x:h1>Abc`, {
      "type": "x:h1",
      "children": ["Abc"]
    });
  ...
  it('should be able to read a single tag', () => {
    test(`<h1>Abc`, {
      "type": "h1",
      "children": ["Abc"]
    });
  ...
  it('should be able to read a single tag with attributes', () => {
  ...
  it('should be able read strings with non-HTML tags', () => {
    test(`<div>
      <h1>Hello</h1>
      <p>World</p>
      <Card c="d">
  ...
  it('should read basic xml files', () => {
  ...
  it("should be able to read complex tags", () => {
